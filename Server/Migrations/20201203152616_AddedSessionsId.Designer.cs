...
namespace TicketReservationSystem.Server.Migrations
{
    ...
    [Migration("20201203152616_AddedSessionsId")]
    partial class AddedSessionsId
    {
            ...
            modelBuilder.Entity("TicketReservationSystem.Shared.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2b$10$xLPYqrqgGx1gVocQ94XOlOFZzLuHBDoTp6ulqK9ZTNdLCgZq0tE9y",
                            Salt = "$2b$06$5d6CBwtwEDICYjHujmJjCu"
                        });
                });
